    ...
    return queryInterface.bulkInsert("proyecto", [
      {
        ...
        enlace: "https://kronenvet.com.ar",
        enlace_github: "https://github.com/enzopinotti/kronenvet-mailing",
      ...
      },
      {
        ...
        enlace: "https://figma.com/proto/example",
        enlace_github: "https://github.com/enzopinotti/figma-prototypes",
        imagen_pastilla: "/images/pastilla2.png",
        max_imagenes: 5
      }
    ], {
      updateOnDuplicate: ["titulo", "descripcion", "fecha_inicio", "fecha_fin", "enlace", "enlace_github", "imagen_pastilla", "max_imagenes"]
    });
  },
